...
class ProfileViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        storageDataManager.managerDelegate = self
    ...
    func addPhotoSheet() {
        ...
        actionSheet.addAction(UIAlertAction.init(title: "Сделать фото", style: UIAlertAction.Style.default, handler: { (_) in
        ...
        actionSheet.addAction(UIAlertAction.init(title: "Установить из галлереи", style: UIAlertAction.Style.default, handler: {(_) in
        ...
        actionSheet.addAction(UIAlertAction.init(title: "Отмена", style: UIAlertAction.Style.cancel, handler: { (_) in
...
extension ProfileViewController: UITextFieldDelegate, UITextViewDelegate {
    @objc func keyboardWillShow(sender: NSNotification) {
        if let keyboardFrame: NSValue = sender.userInfo?[UIResponder.keyboardFrameEndUserInfoKey] as? NSValue {
            self.heigh = Double(self.view.frame.origin.y)
    ...
    @objc func keyboardWillHide(sender: NSNotification) {
        ...
        self.view.frame.origin.y = CGFloat(self.heigh)
    }
